...
public class Singleton_admin {
	public static ArrayList <Admin_class> adm;
                ...
                public static Admin_class loginadmin;
	...
	public static ImageIcon ok = new ImageIcon("src/Modules/Admin/View/img/ok.png");
                ...
                public static ImageIcon defaultavatar = new ImageIcon("src/Modules/Admin/View/img/avatar/default.png");
                public static ImageIcon background = new ImageIcon ("src/Modules/Admin/View/img/brushedmetal.jpg");
                public static ImageIcon addicon = new ImageIcon("src/Modules/Admin/View/img/add_no_over.png");
                public static ImageIcon addicon_over = new ImageIcon("src/Modules/Admin/View/img/add_over.png");
                public static ImageIcon editicon = new ImageIcon("src/Modules/Admin/View/img/edit_no_over.png");
                ...
                public static ImageIcon txticon_over = new ImageIcon("src/Modules/Admin/View/img/txt_over.png");
                public static ImageIcon xmlicon = new ImageIcon("src/Modules/Admin/View/img/xml_no_over.png");
                public static ImageIcon xmlicon_over = new ImageIcon("src/Modules/Admin/View/img/xml_over.png");
                public static String avatarMod="";
                public static String avatarsroute="src/Modules/Admin/View/img/avatar/";
