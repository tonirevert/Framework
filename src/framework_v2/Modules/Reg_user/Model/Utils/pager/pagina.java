package framework_v2.Modules.Reg_user.Model.Utils.pager;
...
//        String option="admin";
        ...
        switch (option) {
            case "admin":
                rowCount = ((miniSimpleTableModel_ruser) framework_v2.Modules.Reg_user.View.Pager_ruser.pagerTable.getModel()).getRowCount();
                break;
